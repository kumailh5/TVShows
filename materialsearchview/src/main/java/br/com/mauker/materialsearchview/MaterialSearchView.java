...
//            values.put(HistoryContract.HistoryEntry.COLUMN_SUB_QUERY, query);
     ...
     */
    public synchronized void  addSuggestion(String suggestion, String subSuggestion) {
        if (!TextUtils.isEmpty(suggestion)) {
            ContentValues value = new ContentValues();
            value.put(HistoryContract.HistoryEntry.COLUMN_QUERY, suggestion);
//            value.put(HistoryContract.HistoryEntry.COLUMN_SUB_QUERY, subSuggestion);
